# FreeRTOS Task、延遲與共享資料：05_freertos_tasks

完整課文、接線、操作與 OLED 訊息意義：[第五篇課文](../../../docs/part5/04_freertos_tasks.md)。
...
arduino-cli --config-file arduino-cli.yaml compile \
  ...
  examples/05_camera_ble_multitasking/05_freertos_tasks
```

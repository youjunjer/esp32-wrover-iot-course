# 藍牙溫溼度與 LED／SG90 控制：02_bluetooth_control

完整課文、接線、操作與 OLED 訊息意義：[第五篇課文](../../../docs/part5/02_bluetooth_control.md)。
...
arduino-cli --config-file arduino-cli.yaml compile \
  ...
  examples/05_camera_ble_multitasking/02_bluetooth_control
```

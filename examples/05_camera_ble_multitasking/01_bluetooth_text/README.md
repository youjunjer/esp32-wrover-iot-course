# Bluetooth Classic 文字傳輸：01_bluetooth_text

完整課文、接線、操作與 OLED 訊息意義：[第五篇課文](../../../docs/part5/01_bluetooth_classic.md)。
...
arduino-cli --config-file arduino-cli.yaml compile \
  ...
  examples/05_camera_ble_multitasking/01_bluetooth_text
```
